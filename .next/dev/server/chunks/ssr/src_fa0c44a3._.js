...
;
// 创建 Supabase 客户端
const supabaseUrl = ("TURBOPACK compile-time value", "your-supabase-url") || '';
const supabaseKey = ("TURBOPACK compile-time value", "your-supabase-anon-key") || '';
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchPosts = async ()=>{
            ...
            try {
                // 从Supabase直接获取文章数据
                const { data: postsData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('posts').select(`
            *, 
          ...
          `).eq('status', 'published').order('created_at', {
                ...
                const formattedPosts = (postsData || []).map((post)=>({
                        ...
                        image: post.image,
                        status: post.status,
                        foundSensitiveWords: post.found_sensitive_words ? JSON.parse(post.found_sensitive_words) : [],
                ...
                // 处理错误
                const errorMessage = error.message || '获取文章失败';
...
//# sourceMappingURL=src_fa0c44a3._.js.map