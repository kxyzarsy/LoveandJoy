...
function middleware(request) {
    ...
    try {
        ...
        const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].verify(token, secretKey);
        // 检查是否需要管理员权限
        ...
        const requiresAdmin = adminOnlyPaths.some((path)=>request.nextUrl.pathname.startsWith(path));
