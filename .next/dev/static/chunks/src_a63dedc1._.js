...
"[project]/src/app/admin-secret.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getCurrentSecret() {
    try {
        ...
        const secret = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.ADMIN_SECRET || 'default-secret-key';
        return secret;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2d$secret$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin-secret.ts [app-client] (ecmascript)");
...
function SecretAdminLoginPage() {
    ...
    const handleInitialSubmit = (e)=>{
        ...
        if (initialPassword === 'admin-portal') {
            ...
            // 记录失败尝试
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2d$secret$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logLoginAttempt"])({
                username: 'unknown',
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            // 记录登录尝试
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2d$secret$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logLoginAttempt"])({
                username,
                ipAddress: ("TURBOPACK compile-time truthy", 1) ? window.location.hostname : "TURBOPACK unreachable",
                userAgent: ("TURBOPACK compile-time truthy", 1) ? navigator.userAgent : "TURBOPACK unreachable",
                isSuccess: false
            ...
            // 验证管理员秘钥
            const isSecretValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2d$secret$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateSecret"])(secretKey);
            if (!isSecretValid) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2d$secret$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logLoginAttempt"])({
                    username,
                    ipAddress: ("TURBOPACK compile-time truthy", 1) ? window.location.hostname : "TURBOPACK unreachable",
            ...
            // 使用管理员专用状态管理工具保存登录状态
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$admin$2d$state$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminAuth"].login(userData, loginData.data.token);
            // 跳转到管理员后台首页
            router.push('/admin');
        } catch (error) {
...
//# sourceMappingURL=src_a63dedc1._.js.map